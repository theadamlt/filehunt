...
else 
{
	...
	elseif(isset($_GET['deleteSuccess'])) echo "<br><div id='error'>Your file wasn't deleted. Please try again later</div><br>";
	// $sql = "SELECT *
	// 		FROM files
	...
	// 		echo "<td><a title='Delete file' onClick=deleteOwnFile('$rowidfile'); href='#'><img src='img/trash.png' height=32 width=32></a></td></tr>";
	// 		++$count;
	// 	}
	...
	// 		echo "</table></center>";
	// }
	// else echo '<br><div id="error">You have no uploads!</div><br>';
}
?>
