...
errorMessage.setAttribute("id","error");errorMessage.innerHTML="You have no uploads!";$("#center").append(errorMessage);}});}function myNewFiles(){$("#center").empty();
$.get("reference.php",{func:"mysubscriptions",action:"files",},function(w){var t=$.parseJSON(w);if(t.length>0){var n=document.getElementById("center");
var g=document.createElement("br");n.appendChild(g);var u=document.createElement("table");u.setAttribute("id","table");var j=document.createElement("tr");
var e=document.createElement("th");e.innerHTML="Filename";var d=document.createElement("th");d.innerHTML="Uploaded by";var b=document.createElement("th");
b.innerHTML="Uploaded date";j.appendChild(e);j.appendChild(d);j.appendChild(b);u.appendChild(j);n.appendChild(u);for(var r=0;r<t.length;r++){var c=t[r]["f_rowID"];
var v=t[r]["f_file"];var s=t[r]["f_uploaded_by"];var l=t[r]["u_username"];var p=t[r]["f_uploaded_date"];var k=document.createElement("tr");if(isEven(r)){k.setAttribute("class","alt");
}var h=document.createElement("td");var o=document.createElement("a");o.setAttribute("href","?page=fileinfo&fileID="+c);o.innerHTML=v;h.appendChild(o);
var f=document.createElement("td");td2Link=document.createElement("a");td2Link.setAttribute("href","?page=profile&userID="+l);td2Link.innerHTML=l;f.appendChild(td2Link);
td3=document.createElement("td");td3.innerHTML=timeConverter(p);k.appendChild(h);k.appendChild(f);k.appendChild(td3);u.appendChild(k);}$("#center").append(u);
g=document.createElement("br");$("#center").append(g);var q=document.createElement("span");q.setAttribute("class","submit");var a=document.createElement("input");
a.setAttribute("type","button");a.setAttribute("onclick","clearSubList()");a.setAttribute("value","Clear list");q.appendChild(a);$("#center").append(q);
}else{var m=document.createElement("div");m.setAttribute("id","error");m.innerHTML="You have no unseen files";var g=document.createElement("br");$("#center").append(g);
$("#center").append(m);}});}function clearSubList(){$.get("reference.php",{func:"clear_sub_list",},function(b){var a=document.getElementById("mysubsbar");
...
}});}else{$(".mysubscribers").attr("id","error").html("You have no subscribers");}});}function myNewFiles2(){$.get("reference.php",{func:"mysubscriptions",action:"files_num"},function(c){if(c>0){$("#newfiles_pointer").html("► ");
...
var v=document.createElement("table");v.setAttribute("id","table");var n=document.createElement("tr");var k=document.createElement("th");k.innerHTML="Filename";
var h=document.createElement("th");h.innerHTML="Uploaded by";var f=document.createElement("th");f.innerHTML="Uploaded date";n.appendChild(k);n.appendChild(h);
n.appendChild(f);v.appendChild(n);for(var s=0;s<u.length;s++){var g=u[s]["f_rowID"];var w=u[s]["f_file"];var t=u[s]["f_uploaded_by"];var p=u[s]["u_username"];
var r=u[s]["f_uploaded_date"];var j=u[s]["f_rowID"];var o=document.createElement("tr");if(isEven(s)){o.setAttribute("class","alt");}var m=document.createElement("td");
var q=document.createElement("a");q.setAttribute("href","?page=fileinfo&fileID="+g);q.innerHTML=w;m.appendChild(q);var l=document.createElement("td");td2Link=document.createElement("a");
td2Link.setAttribute("href","?page=profile&userID="+p);td2Link.innerHTML=p;l.appendChild(td2Link);td3=document.createElement("td");td3.innerHTML=timeConverter(r);
o.appendChild(m);o.appendChild(l);o.appendChild(td3);v.appendChild(o);}$(".newfiles_content").empty();$(".newfiles_content").append(v);});}else{$(".newfiles_content").slideToggle("fast");
}});}else{$("#newfiles_pointer").append(linebreak);$("#newfiles_pointer").append(linebreak);$(".newfiles").attr("id","error").html("You have no unseen files");
}});}