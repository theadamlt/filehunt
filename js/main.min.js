...
$(".newfiles_content").append(d);$(".newfiles_content").slideToggle("fast");$.get("reference.php",{func:"mysubscriptions",action:"files",},function(p){var v=$.parseJSON(p);
var u=document.createElement("table");u.setAttribute("id","table");var o=document.createElement("tr");var j=document.createElement("th");j.innerHTML="Filename";
var h=document.createElement("th");h.innerHTML="Uploaded by";var g=document.createElement("th");g.innerHTML="Uploaded date";o.appendChild(j);o.appendChild(h);
o.appendChild(g);u.appendChild(o);for(var q=0;q<v.length;q++){var t=v[q]["f_rowID"];var n=v[q]["f_file"];var f=v[q]["f_uploaded_by"];var s=v[q]["u_username"];
var m=v[q]["f_uploaded_date"];var w=document.createElement("tr");if(isEven(q)){w.setAttribute("class","alt");}var l=document.createElement("td");var r=document.createElement("a");
r.setAttribute("href","?page=fileinfo&fileID="+t);r.innerHTML=n;l.appendChild(r);var k=document.createElement("td");td2Link=document.createElement("a");
td2Link.setAttribute("href","?page=profile&userID="+f);td2Link.innerHTML=s;k.appendChild(td2Link);td3=document.createElement("td");td3.innerHTML=timeConverter(m);
w.appendChild(l);w.appendChild(k);w.appendChild(td3);u.appendChild(w);}$(".newfiles_content").empty();$(".newfiles_content").append(u);});}else{$(".newfiles_content").slideToggle("fast");
