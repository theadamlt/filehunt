...
var c=document.getElementById("timesDownloaded");var a=c.innerHTML;c.innerHTML=parseInt(a)+1;}function mail(){var a=document.mail.subject.value;var b=document.mail.message.value;
$.get("reference.php",{subject:a,message:b,func:"mail",},function(c){console.log(c);});return false;}