...
td3=document.createElement("td");td3.innerHTML=c;o.appendChild(m);o.appendChild(k);o.appendChild(td3);u.appendChild(o);}$("#comments").append(u);}});}function fileInfo(){qs();
var a=qsParm.fileID;$.get("reference.php",{func:"fileinfo",file:a,action:"is_reported",},function(b){if(b=="true"){var c=document.createElement("div");
...
}else{var x=$.parseJSON(b);var e=x[0]["f_rowID"];var w=x[0]["f_uploaded_by"];var l=x[0]["u_username"];var f=x[0]["u_rowID"];var v=x[0]["f_uploaded_date"];
var j=x[0]["f_mimetype"];var t=x[0]["f_size"];var y=document.createElement("table");y.setAttribute("id","table");var r=document.createElement("th");r.innerHTML="Uploaded by";
var q=document.createElement("th");q.innerHTML="Size";var p=document.createElement("th");p.innerHTML="Date uploaded";var o=document.createElement("th");
o.innerHTML="Mimetype";if(j.substring(0,6)=="image/"){var n=document.createElement("th");n.innerHTML="Dimension";}var m=document.createElement("th");m.innerHTML="Times downloaded";
y.appendChild(r);y.appendChild(q);y.appendChild(p);y.appendChild(o);if(j.substring(0,6)=="image/"){y.appendChild(n);}y.appendChild(m);var k=document.createElement("tr");
k.setAttribute("class","alt");var i=document.createElement("td");td1Link=document.createElement("a");td1Link.setAttribute("href","?page=profile&userID="+f);
td1Link.innerHTML=l;i.appendChild(td1Link);var g=document.createElement("td");g.innerHTML=calcFileSize(t);td3=document.createElement("td");td3.innerHTML=timeConverter(v);
td4=document.createElement("td");td4.innerHTML=j;if(j.substring(0,6)=="image/"){var d=document.createElement("td");var z=new Image();z.src="./printimage.php?id="+e;
z.onload=function(){width=this.width;height=this.height;d.innerHTML="Height: "+height+"Width: "+width;};}var c=document.createElement("td");var u=document.createElement("a");
u.setAttribute("href","?page=download_analysis&file="+a);$.get("reference.php",{func:"fileinfo",action:"times_downloaded",file:a,},function(A){u.innerHTML=A;
...
}});}function placeComment(){qs();var a=qsParm.fileID;if(document.comment.comment.value!=""){$.get("reference.php",{func:"place_comment",comment:document.comment.comment.value,file:a,},function(c){loadComments(a);
