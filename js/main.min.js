...
$("#username_label").prepend(errorImg);}username_success=false;}else{username_success=true;}if(f==true&&username_success==true&&a==true&&c==true){$.post("reference.php",{func:"signup",username:e,email:g,password:MD5(i),recaptcha_challenge_field:document.signup.recaptcha_challenge_field.value,recaptcha_response_field:document.signup.recaptcha_response_field.value,},function(j){if(j=="capcha_error"){window.location="?page=signup&capchaError=true";
