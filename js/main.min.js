...
}});return false;}function profile(){var a=qs.userID;$.get("reference.php",{func:"profile",userID:a,},function(b){});}function loadsubs(){var c=document.createElement("details");
c.setAttribute("class","mysubbers");var b=document.createElement("summary");b.innerHTML="Subs click me";c.appendChild(b);var a=document.createElement("span");
a.setAttribute("class","conthere");c.appendChild(a);$(".cont").append(c);}function clickme(){$(".mysubbers").click(function(){$(".conthere").html("hej");
});}function mySubscriptions(){$.get("reference.php",{func:"mysubscriptions",action:"mysubscriptions_num",},function(c){if(c>0){$("#mysubscribtions_pointer").html("► ");
...
}});}else{$(".mysubscribers").attr("id","error").html("You have no subscribers");}});}