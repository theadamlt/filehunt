...
});}function userPref(){var c=document.user_pref.real_name.value;var b=document.user_pref.email.value;var g=document.user_pref.show_name.checked;var a=document.user_pref.show_mail.checked;
var e=document.user_pref.twitter_id.value;var f=document.user_pref.facebook_id.value;var d=/^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/;
if(IsEmpty(c)==true&&d.test(b)==true){$.get("reference.php",{func:"user_pref",real_name:c,email:b,show_real_name:g,show_email:a,twitter_id:e,facebook_id:f,},function(h){if(h=="true"){$(".upSuccess").empty();
