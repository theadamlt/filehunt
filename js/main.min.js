...
$("html,body").animate({scrollTop:$("#success").offset().top},1000);$(".npError").fadeOut();$("#np-wrapper").fadeOut("slow");document.newpassword.password.value=null;
...
if(n.length>0){var a=document.getElementById("myfiles");var m=document.createElement("table");m.setAttribute("id","table");var g=document.createElement("tr");
...
errorMessage.setAttribute("id","error");errorMessage.innerHTML="You have no uploads!";$("#tabs-1").append(errorMessage);}});}function clearSubList(){$(".newfiles_content").empty();
$.get("reference.php",{func:"clear_sub_list",},function(b){var a=document.getElementById("mysubsbar");$.get("reference.php",{func:"mysubscriptions",action:"files_num",},function(c){a.innerHTML="Subscriptions ("+c+")";
myNewFiles();});});}function loadComments(a){$("#comments_table").empty();$.get("reference.php",{func:"comments",file:a,},function(b){if(b=="false"){if(isLoggedIn()!="false"){var q=document.createElement("div");
q.setAttribute("id","error");q.innerHTML="There is no comments for this file. Why dont you leave one?";var l=document.createElement("br");$("#comments_table").prepend(l);
$("#comments_table").prepend(q);}}else{var s=$.parseJSON(b);var t=document.createElement("table");t.setAttribute("id","table");t.setAttribute("style","width:75%;");
var n=document.createElement("tr");var h=document.createElement("th");h.innerHTML="Comment by";var g=document.createElement("th");g.innerHTML="Date commented";
var e=document.createElement("th");e.innerHTML="Comment";n.appendChild(h);n.appendChild(g);n.appendChild(e);t.appendChild(n);for(var r=0;r<s.length;r++){var f=s[r]["user_row"];
var j=s[r]["username"];var c=s[r]["comment"];var d=s[r]["date_commented"];var o=document.createElement("tr");if(isEven(r)){o.setAttribute("class","alt");
}var m=document.createElement("td");var p=document.createElement("a");p.setAttribute("href","?page=profile&userID="+f);p.innerHTML=j;m.appendChild(p);var k=document.createElement("td");
k.innerHTML=timeConverter(d);td3=document.createElement("td");td3.innerHTML=c;o.appendChild(m);o.appendChild(k);o.appendChild(td3);t.appendChild(o);}$("#comments_table").append(t);
}});}function fileInfo(){var a=qs.fileID;$.get("reference.php",{func:"fileinfo",file:a,action:"is_reported",},function(b){if(b=="true"){var c=document.createElement("div");
c.setAttribute("id","error");c.innerHTML="Be careful! This file has been reported at abuse! We are on the case. You can still download the file, but: BE CAREFUL!";
$("#warning").prepend(c);}});$.get("reference.php",{func:"fileinfo",action:"fileinfo",file:a,},function(b){if(b=="false"){window.location.href="?page=search";
}else{var A=$.parseJSON(b);var f=A[0]["f_rowID"];var z=A[0]["f_uploaded_by"];var m=A[0]["u_username"];var g=A[0]["u_rowID"];var y=A[0]["f_uploaded_date"];
var k=A[0]["f_mimetype"];var v=A[0]["f_size"];var C=A[0]["f_file"];var x=A[0]["f_description"];$("#header").html(C);var B=document.createElement("table");
B.setAttribute("id","table");var s=document.createElement("th");s.innerHTML="Uploaded by";var r=document.createElement("th");r.innerHTML="Size";var q=document.createElement("th");
q.innerHTML="Date uploaded";var p=document.createElement("th");p.innerHTML="Mimetype";if(k.substring(0,6)=="image/"){var o=document.createElement("th");
o.innerHTML="Dimension";}var n=document.createElement("th");n.innerHTML="Times downloaded";B.appendChild(s);B.appendChild(r);B.appendChild(q);B.appendChild(p);
if(k.substring(0,6)=="image/"){B.appendChild(o);}B.appendChild(n);var l=document.createElement("tr");l.setAttribute("class","alt");var j=document.createElement("td");
td1Link=document.createElement("a");td1Link.setAttribute("href","?page=profile&userID="+g);td1Link.innerHTML=m;j.appendChild(td1Link);var h=document.createElement("td");
h.innerHTML=calcFileSize(v);td3=document.createElement("td");td3.innerHTML=timeConverter(y);td4=document.createElement("td");td4.innerHTML=k;if(k.substring(0,6)=="image/"){var e=document.createElement("td");
var D=new Image();D.src="./printimage.php?id="+f;D.onload=function(){width=this.width;height=this.height;e.innerHTML="Height: "+height+"Width: "+width;
};}var c=document.createElement("td");var w=document.createElement("a");w.setAttribute("href","?page=download_analysis&file="+a);w.setAttribute("id","timesDownloaded");
$.get("reference.php",{func:"fileinfo",action:"times_downloaded",file:a,},function(E){w.innerHTML=E;});c.appendChild(w);l.appendChild(j);l.appendChild(h);
l.appendChild(td3);l.appendChild(td4);if(k.substring(0,6)=="image/"){l.appendChild(e);}l.appendChild(c);B.appendChild(l);$("#info").prepend(B);var i=document.createElement("br");
$("#cont").append(i);$("#cont").append(i);$("#cont").append(i);}var k=A[0]["f_mimetype"];var f=A[0]["f_rowID"];if(!empty(x)){var t=document.createElement("fieldset");
var d=document.createElement("legend");d.innerHTML="Description";t.innerHTML=x;t.appendChild(d);$("#info").append(i);$("#info").append(t);}if(k.substring(0,6)=="image/"){$("#showme").css("visibility","visible");
var u=document.createElement("img");u.setAttribute("src","printimage.php?id="+f);u.style.width="70%";u.style.height="auto";var i=document.createElement("br");
$("#preview").append(u);}});loadComments(a);$.get("reference.php",{func:"isloggedin",},function(c){if(c!="false"){var i=document.createElement("br");$("#commentform").append(i);
var b=document.createElement("form");b.setAttribute("class","form");b.setAttribute("name","comment");var e=document.createElement("span");textArea1=document.createElement("textarea");
textArea1.setAttribute("name","comment");textArea1.setAttribute("cols","40");textArea1.setAttribute("rows","6");textArea1.setAttribute("Placeholder","Comment");
textArea1.setAttribute("id","message");e.appendChild(textArea1);var d=document.createElement("p");d.setAttribute("class","submit");var f=document.createElement("input");
f.setAttribute("type","hidden");f.setAttribute("name","submit");f.setAttribute("value","true");var h=document.createElement("input");h.setAttribute("value","Submit");
h.setAttribute("type","button");h.setAttribute("onclick","placeComment()");d.appendChild(h);b.appendChild(f);b.appendChild(e);b.appendChild(d);$("#commentform").append(b);
}else{var g=document.createElement("div");g.setAttribute("id","error");g.innerHTML="In order to comment, you need to ";var j=document.createElement("a");
j.setAttribute("href","?page=login&attemptedSite=fileinfo&file="+a);j.innerHTML="login";g.appendChild(j);$("#commentform").append(g);}});}function placeComment(){var a=qs.fileID;
if(document.comment.comment.value!=""){$.get("reference.php",{func:"place_comment",comment:document.comment.comment.value,file:a,},function(c){loadComments(a);
...
k.href="?page=search";k.innerHTML="Home";r.appendChild(k);q.appendChild(r);var x=document.createElement("li");x.id="upload";var m=document.createElement("a");
...
}});return false;}function profile(){var a=qs.userID;$.get("reference.php",{func:"profile",userID:a,},function(b){});}function mySubscriptions(){$.get("reference.php",{func:"mysubscriptions",action:"mysubscriptions_num",},function(c){if(c>0){$("#mysubscribtions_pointer").html("► ");
var b=false;var a=false;$(".mysubscribtions").attr("title","Click me").html("My subscriptions("+c+")");$(".mysubscribtions").click(function(){var e=$("#mysubscribtions_pointer").html();
if(e=="► "){$("#mysubscribtions_pointer").html("▼ ");}else{$("#mysubscribtions_pointer").html("► ");}if(a==false){var d=document.createElement("img");d.setAttribute("src","img/load.gif");
$(".mysubscribtions_content").append(d);$(".mysubscribtions_content").slideToggle("fast");$.get("reference.php",{func:"mysubscriptions",action:"mysubscriptions",},function(k){$(".mysubscribtions_content").empty();
var g=$.parseJSON(k);for(var f=0;f<g.length;f++){var j=document.createElement("a");j.setAttribute("href","?page=profile&userID="+g[f]["u_rowID"]);j.innerHTML=g[f]["u_username"];
$(".mysubscribtions_content").append(j);var h=document.createElement("br");$(".mysubscribtions_content").append(h);a=true;}});}else{$(".mysubscribtions_content").slideToggle("fast");
}});}else{$(".mysubscribtions").id("error").html("You have no subscriptions");}});}function mySubscribers(){$.get("reference.php",{func:"mysubscriptions",action:"mysubscribers_num",},function(c){if(c>0){$("#mysubscribers_pointer").html("► ");
var b=false;var a=false;$(".mysubscribers").attr("title","Click me").html("My subscribers("+c+")");$(".mysubscribers").click(function(){var e=$("#mysubscribers_pointer").html();
if(e=="► "){$("#mysubscribers_pointer").html("▼ ");}else{$("#mysubscribers_pointer").html("► ");}if(a==false){var d=document.createElement("img");d.setAttribute("src","img/load.gif");
$(".mysubscribers_content").append(d);$(".mysubscribers_content").slideToggle("fast");$.get("reference.php",{func:"mysubscriptions",action:"mysubscribers",},function(k){$(".mysubscribers_content").empty();
var g=$.parseJSON(k);for(var f=0;f<g.length;f++){var j=document.createElement("a");j.setAttribute("href","?page=profile&userID="+g[f]["u_rowID"]);j.innerHTML=g[f]["u_username"];
$(".mysubscribers_content").append(j);var h=document.createElement("br");$(".mysubscribers_content").append(h);a=true;}});}else{$(".mysubscribers_content").slideToggle("fast");
}});}else{$(".mysubscribers").attr("id","error").html("You have no subscribers");}});}function myNewFiles(){$.get("reference.php",{func:"mysubscriptions",action:"files_num"},function(c){if(c>0){$("#newfiles_pointer").html("► ");
var b=false;var a=false;$(".newfiles").attr("title","Click me").html("Unseen files("+c+")");$(".newfiles").click(function(){var e=$("#newfiles_pointer").html();
if(e=="► "){$("#newfiles_pointer").html("▼ ");}else{$("#newfiles_pointer").html("► ");}if(a==false){a=true;var d=document.createElement("img");d.setAttribute("src","img/load.gif");
$(".newfiles_content").append(d);$(".newfiles_content").slideToggle("fast");$.get("reference.php",{func:"mysubscriptions",action:"files",},function(x){var u=$.parseJSON(x);
var v=document.createElement("table");v.setAttribute("id","table");var o=document.createElement("tr");var l=document.createElement("th");l.innerHTML="Filename";
var j=document.createElement("th");j.innerHTML="Uploaded by";var g=document.createElement("th");g.innerHTML="Uploaded date";o.appendChild(l);o.appendChild(j);
o.appendChild(g);v.appendChild(o);for(var t=0;t<u.length;t++){var h=u[t]["f_rowID"];var w=u[t]["f_file"];var k=u[t]["f_uploaded_by"];var q=u[t]["u_username"];
var s=u[t]["f_uploaded_date"];var p=document.createElement("tr");if(isEven(t)){p.setAttribute("class","alt");}var n=document.createElement("td");var r=document.createElement("a");
r.setAttribute("href","?page=fileinfo&fileID="+h);r.innerHTML=w;n.appendChild(r);var m=document.createElement("td");td2Link=document.createElement("a");
td2Link.setAttribute("href","?page=profile&userID="+k);td2Link.innerHTML=q;m.appendChild(td2Link);td3=document.createElement("td");td3.innerHTML=timeConverter(s);
p.appendChild(n);p.appendChild(m);p.appendChild(td3);v.appendChild(p);}$(".newfiles_content").empty();$(".newfiles_content").append(v);var f=document.createElement("input");
f.setAttribute("class","submit");f.setAttribute("value","Clear list");f.setAttribute("onclick","clearSubList();");f.setAttribute("type","button");$(".newfiles_content").append(f);
});}else{$(".newfiles_content").slideToggle("fast");}});}else{$("#newfiles_pointer").empty();$(".newfiles").css("cursor","default");$("#newfiles_pointer").append(linebreak);
$("#newfiles_pointer").append(linebreak);$(".newfiles").attr("id","error").html("You have no unseen files");}});}