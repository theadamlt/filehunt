...
<div class="subscribtions">
	<span id="mysubscribtions_pointer"></span>
	<span class="mysubscribtions"></span>
	...
	<span id="mysubscribers_pointer"></span>
	<span class="mysubscribers"></span>

	<div class="mysubscribers_content" style="display: none"></div>
	<br>
	<br>
	<span id="newfiles_pointer"></span>
	<span class="newfiles"></span>
